...
public class BadRequest extends WebApplicationException {
    ...
    private static final Logger LOGGER = Logger.getLogger("BadRequest");
    ...
    public BadRequest(String message, Throwable cause) {
        super(cause, Response.status(Status.BAD_REQUEST.getStatusCode()).entity(message).type(MediaType.TEXT_PLAIN).build());
        if (cause != null) {
